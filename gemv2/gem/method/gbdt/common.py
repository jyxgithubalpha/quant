"""
GBDT common utilities: GBDTImportanceExtractor.
"""
...
class GBDTImportanceExtractor(BaseImportanceExtractor):
    ...
    Supports LightGBM, XGBoost, CatBoost through auto-detection or explicit
    framework selection.
    """
    ...
    def _detect_framework(self, model: Any) -> str:
        """Auto-detect model framework from module path and attribute inspection."""
        ...
        if hasattr(model, "feature_importance") and hasattr(model, "best_iteration"):
            return "lightgbm"
...
__all__ = ["GBDTImportanceExtractor"]
